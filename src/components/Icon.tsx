...
export function SparklesIcon({ size = 24, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
      <path d="M12 3v1M12 20v1M4.2 4.2l.7.7M19.1 19.1l.7.7M3 12H2M22 12h-1M4.2 19.8l.7-.7M19.1 4.9l.7-.7" />
      <path d="M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Z" />
    </svg>
  );
}

export function CrownIcon({ size = 24, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
      <path d="M3 17L5 8l4.5 4L12 4l2.5 8L19 8l2 9H3Z" />
      <path d="M3 17h18" />
    </svg>
  );
}
...
export function ThreadsIcon({ size = 24, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
      <path d="M9 5H7a4 4 0 0 0-4 4v6a4 4 0 0 0 4 4h10a4 4 0 0 0 4-4V9a4 4 0 0 0-4-4h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2" />
    </svg>
  );
}

export function VisaCardIcon({ size = 24, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
...
export function ThumbUpIcon({ size = 24, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
      <path d="M7 10v10H4a1 1 0 0 1-1-1v-8a1 1 0 0 1 1-1h3Z" />
      <path d="M7 10l3-7a3 3 0 0 1 6 0v3h4a1 1 0 0 1 1 1l-1.5 7a1 1 0 0 1-1 .8H7" />
    </svg>
  );
}
...
export function FireIcon({ size = 24, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
      <path d="M8.5 14c0-4 4.5-6 4.5-10 2.5 2 4 4.5 4 7a4.5 4.5 0 0 1-9 0Z" />
      <path d="M10 17.5a2.5 2.5 0 0 0 4 0" />
    </svg>
  );
}
