...
export function BookingForm({ providerId }: { providerId: number }) {
  ...
  if (status === "success") {
    return (
      <div className="mt-5 rounded-[24px] bg-[#e8f8ef] border border-emerald-200/70 p-6 text-center">
      ...
      <label className="block">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="w-10 h-10 rounded-full bg-[#f5f5f7] border border-black/[0.06] font-semibold hover:bg-black/[0.04]"
          >
            −
          </button>
